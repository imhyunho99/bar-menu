    ...
    <>
      ...
      <div className="wrapper">
        ...
        <main>
          ...
          <div className="last-update">공시일자: 2026년 8월 16일 (시행일자: 2026년 8월 16일)</div>
          ...
          <div className="policy-container">
            ...
            <section className="policy-section">
              ...
              <ul>
                ...
                <li><strong>Pro Plan (월 19,900원)</strong>: Entry의 모든 기능 + 주문·결제 연동, 와이파이 간편 접속 제공, 매장 외부 접근 제한(IP/SSID 매칭) 보안, 스크린샷 캡처 차단 제공.</li>
            ...
            <section className="policy-section">
              <h2>제 5 조 (서비스 제공기간 및 청약철회)</h2>
              <ul>
                <li><strong>제공 개시</strong>: 본 서비스는 별도의 배송이 없는 온라인 디지털 서비스입니다. 결제가 확인되는 즉시 손님용 메뉴판이 열리며, 그 시점부터 서비스가 개시된 것으로 봅니다.</li>
                <li><strong>제공기간</strong>: 1개월 단위로 제공되며, 해지하지 않으면 매월 같은 날 자동으로 갱신됩니다.</li>
                <li><strong>청약철회</strong>: 결제일로부터 7일 이내이고 아직 서비스를 개시하지 않은 경우(메뉴 등록·QR 생성 등 이용 이력이 없는 경우) 청약철회하실 수 있으며 전액 환불됩니다.</li>
                <li><strong>청약철회의 제한</strong>: 이미 서비스를 개시한 경우, 그리고 Premium Plan의 맞춤 디자인 용역이 착수된 경우에는 그 부분에 한해 청약철회가 제한됩니다. 이 경우에도 남은 기간에 대한 해지는 언제든 가능합니다.</li>
              </ul>
            </section>

            <section className="policy-section">
              <h2>제 6 조 (결제 이의신청 및 분쟁 처리)</h2>
              <p>
                결제 금액·결제일·자동갱신 등 결제 내역에 이의가 있으신 경우, 사이트 하단에 안내된 연락처 또는 문의하기를 통해 접수해 주시면 3영업일 이내에 확인 결과를 회신드립니다. 확인 결과 회사의 착오로 인한 과오금이 있는 경우 전액을 즉시 환급하며, 결제수단으로의 환급이 불가한 때에는 회원이 지정한 계좌로 지급합니다.
              </p>
              <p>
                회사와 회원 사이에 분쟁이 발생한 경우 양 당사자는 성실히 협의하며, 협의가 이루어지지 않을 때에는 「전자상거래 등에서의 소비자보호에 관한 법률」에 따라 한국소비자원 등 관련 기관에 조정을 신청할 수 있습니다.
              </p>
            </section>

            <section className="policy-section">
              <h2>제 7 조 (보안 및 접근 제어 책임)</h2>
              <p>
            ...
            <section className="policy-section">
              <h2>제 8 조 (서비스 면책 조항)</h2>
              <p>
                회사는 클라우드 인프라 파트너 및 결제대행사(PG)의 자체 네트워크 장애로 인하여 발생하는 일시적인 메뉴판 노출 지연 혹은 결제 실패에 대하여는 책임을 지지 않습니다. 단, 회사의 귀책 사유로 인하여 연속 24시간 이상 전체 서비스 장애가 발생하는 경우 가맹점주의 요청에 의해 해당 월 요금의 일할 상당액을 감면 또는 보상합니다.
              </p>
